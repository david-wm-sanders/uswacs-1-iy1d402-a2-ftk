...
\hline
Filename (incl. ext.)  & x & Hash (MD5)          & x \tabularnewline \hline
...
Evidence Description   & \multicolumn{3}{l|}{x}      \tabularnewline \hline
Technique used         & \multicolumn{3}{l|}{x}      \tabularnewline \hline
Reason for selection   & \multicolumn{3}{l|}{x}      \tabularnewline \hline
\end{tabularx}
\end{table}
